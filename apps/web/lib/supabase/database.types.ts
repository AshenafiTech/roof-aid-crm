    ...
    Tables: {
      ...
      appointments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "appointments_rufero_id_fkey"
            columns: ["rufero_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      commission_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "commission_transactions_supplement_id_fkey"
      ...
      inspection_reports: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "inspection_reports_prospect_id_fkey"
            columns: ["prospect_id"]
            isOneToOne: false
            referencedRelation: "prospects"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "inspection_reports_rufero_id_fkey"
            columns: ["rufero_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      prospects: {
        ...
        Relationships: [
          {
            foreignKeyName: "prospects_assigned_by_fkey"
            columns: ["assigned_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      sms_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sms_logs_prospect_id_fkey"
            columns: ["prospect_id"]
            isOneToOne: false
            referencedRelation: "prospects"
            referencedColumns: ["id"]
      ...
      supplements: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "supplements_document_id_fkey"
            columns: ["document_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "supplements_prospect_id_fkey"
            columns: ["prospect_id"]
            isOneToOne: false
            referencedRelation: "prospects"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "supplements_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      users: {
        Row: {
          ...
          home_base_coords: unknown
          id: string
          is_active: boolean | null
          last_name: string | null
          phone: string | null
          role: string
          sendgrid_sender: string | null
          telnyx_extension: string | null
          tenant_id: string
          updated_at: string | null
        }
        Insert: {
