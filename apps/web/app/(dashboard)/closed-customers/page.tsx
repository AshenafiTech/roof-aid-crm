...
export const metadata = {
  title: "Closed Customers — Roof-Aid CRM",
};

export default async function ClosedCustomersPage({
  searchParams,
}: {
  ...
  return (
    <ProspectListView
      ...
      basePath="/closed-customers"
      statusFilter="closed_customer"
